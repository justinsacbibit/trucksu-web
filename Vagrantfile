...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :shell, path: 'vagrant/postgresql_setup.sh'
  config.vm.provision :shell, path: 'vagrant/elixir_setup.sh'
  config.vm.provision :shell, path: 'vagrant/phoenix_setup.sh', privileged: false
  config.vm.provision :shell, path: 'vagrant/shell_setup.sh'
